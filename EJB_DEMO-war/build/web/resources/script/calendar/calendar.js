...
function convertEcToGc(day) {
    ...
    document.getElementById("div3").innerHTML = "<table style='color:white;' ><tr><td>GC Equivalent: </td><td width='85'>" + ECtoGC_Converter(day, month, year) + "</td><td><a style='cursor:pointer;text-decoration:none;color:#FF82AB;padding:1px;' onclick='ice_hide()'>Hide</a></td></tr></table>";
...
function getToday() {
    ...
    var currentGcMonth = parseInt(today.getMonth());
    var currentGcYear = parseInt(today.getFullYear());
    document.getElementById("div3").innerHTML = "<table style='color:white;'><tr><td>GC Equivalent: </td><td width='85'>" + currentGcDay + "/" + (currentGcMonth + 1) + "/" + currentGcYear + "</td><td><a  style='text-decoration:none;color:#FF82AB;padding:1px; text-align:right;' onclick='ice_hide()'>Hide</a></td></tr></table>";
    //the following 1 line js code pass the feached current date to EC convertor function and put the returned date value in a
    //string format to convertedDate variable which holds the Ethiopian equivalent of system current GC date.
    var convertedDate = GCtoEC_Converter(currentGcDay, currentGcMonth, currentGcYear);
